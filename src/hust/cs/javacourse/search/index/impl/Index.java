...
public class Index extends AbstractIndex {
    ...
    public String toString() {
        ...
        for(AbstractTerm t:this.termToPostingListMapping.keySet()) output += t+" ";
        output += "\ndocId-----docPath mapping:\n";
        for(int id:this.docIdToDocPathMapping.keySet()){
            output += id + "    ---->    "+this.docIdToDocPathMapping.get(id)+"\n";
        }
        output += "PostingList:\n";
        for(AbstractTerm t:this.termToPostingListMapping.keySet()){
            output += t + "    ---->    "+this.termToPostingListMapping.get(t).toString()+"\n";
        }
        return output;
    }
